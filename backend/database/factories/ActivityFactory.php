...
class ActivityFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'location' => $this->faker->randomElement([
                'Prague','Budapest','Amsterdam','Lisbon','Valencia'
            ]),
            'transport_mode' => $type === 'Transport'
                ? $this->faker->randomElement($this->transportModes) : null,
            'accommodation_class' => $type === 'Accommodation'
                ? $this->faker->randomElement($this->accClasses) : null,
    ...
    public function transport(string $mode)  { return $this->state(['type' => 'Transport','transport_mode' => $mode]); }
    public function accommodation(string $cls){ return $this->state(['type' => 'Accommodation','accommodation_class' => $cls]); }
